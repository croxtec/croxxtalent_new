<template>
  <div>
    <h4 class="mb-1">Welcome to Croxxtalent!</h4>
    <p>
      These terms and conditions outline the rules and regulations for the use
      of Croxxtalent's Website, located at&nbsp;<a
        href="https://croxxtalent.io./"
        >https://croxxtalent.io</a
      >.
    </p>
    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Croxxtalent if you do not agree to take all of the
    ...
    <p>
      ...
      Company&rsquo;s terms and conditions. "The Company", "Ourselves", "We",
      "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers
      to both the Client and ourselves. All terms refer to the offer, acceptance
      ...
      purpose of meeting the Client&rsquo;s needs in respect of provision of the
    ...
    <hr />
    <h4 class="mb-1"><span>1. Cookies</span></h4>
    <p>
      We employ the use of cookies. By accessing Croxxtalent, you agreed to use
      cookies in agreement with the Croxxtalent's Privacy Policy.
    </p>
    <p>
      Most interactive websites use cookies to let us retrieve the user&rsquo;s
      details for each visit. Cookies are used by our website to enable the
      functionality of certain areas to make it easier for people visiting our
      website. Some of our affiliate/advertising partners may also use cookies.
    </p>
    <hr />
    <h4 class="mb-1"><span>2. License</span></h4>
    <p>
      Unless otherwise stated, Croxxtalent and/or its licensors own the
      intellectual property rights for all material on Croxxtalent. All
      intellectual property rights are reserved. You may access this from
      Croxxtalent for your own personal use subjected to restrictions set in
      these terms and conditions.
    </p>
    <p>You must not:</p>
    <ul>
      <li>Republish material from Croxxtalent</li>
      <li>Sell, rent or sub-license material from Croxxtalent</li>
      <li>Reproduce, duplicate or copy material from Croxxtalent</li>
      <li>Redistribute content from Croxxtalent</li>
    </ul>
    <p>
      This Agreement shall begin on the date hereof. Our Terms and Conditions
      were created with the help of the&nbsp;<a
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Croxxtalent does
      ...
      Croxxtalent,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, Croxxtalent shall not be liable for the
    ...
    <p>
      Croxxtalent reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Croxxtalent a non-exclusive license to use, reproduce,
      edit and authorize others to use, reproduce and edit any of your Comments
      in any and all forms, formats or media.
    </p>
    <hr />
    <h4 class="mb-1"><span>3. Hyperlinking to our Content</span></h4>
    <p>
    ...
    <p>
      ...
      context of the linking party&rsquo;s site.
    </p>
    <p>
    ...
    <p>
      ...
      hyperlink compensates the absence of Croxxtalent; and (d) the link is in
    ...
    <p>
      ...
      and (c) fits within the context of the linking party&rsquo;s site.
    </p>
    <p>
      If you are one of the organizations listed in paragraph 2 above and are
      interested in linking to our website, you must inform us by sending an
      e-mail to Croxxtalent. Please include your name, your organization name,
    ...
    <p>
      No use of Croxxtalent's logo or other artwork will be allowed for linking
      absent a trademark license agreement.
    </p>
    <hr />
    <h4 class="mb-1"><span>4. iFrames</span></h4>
    <p>
    ...
    <hr />
    <h4 class="mb-1"><span>5. Content Liability</span></h4>
    <p>
    ...
    <hr />
    <h4 class="mb-1"><span>9. Disclaimer</span></h4>
    <p>
