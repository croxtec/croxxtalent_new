      ...
      <div class="data--container">
        <div class="left--side_data">
          <div class="data--card">
            ...
            <p class="body--text">
              ...
              or an employer seeking top talent, CroxxTalent has everything you need 
              to make it happen.
            </p>
          </div>
          <div class="data--card">
        ...
        <div class="right--side_data">
          <div class="data--bottom_card">
            ...
            <p class="body--text">
              Find the right job for you and build a stronger team with our personalized 
          ...
          <div class="data--bottom_card">
            ...
            <p class="body--text">
              Maximizing value for your budget with cost-efficient solutions - you don’t have 
              to break the bank to get the quality of services you need.
            </p>
          </div>
        </div>
      </div>
