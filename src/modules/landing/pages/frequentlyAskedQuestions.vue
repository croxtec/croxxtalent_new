<template>
  <div>
      ...
      <div class="faq-cards">
        <div class="faq-card">
          ...
          <div>
            <h5>C.V Downloads</h5>
            <p class="body--text">
              Learn more on how you can download free and customizable 
              C.V. templates to showcase your skills and experience to 
              potential employers.
            </p>
          </div>
        </div>
        ...
        <div class="faq-card">
          ...
          <div>
            ...
            <p class="body--text">
              ...
              all of your job applications in one place with our application management system.
            </p>
          </div>
        </div>
        <div class="faq-card">
        ...
        <div class="faq-card">
          ...
          <div>
            ...
            <p class="body--text">
              Find out how you can identify the strengths and weaknesses of talents with our skill assessments 
              and how jobseekers can receive customized training and development plans.
            </p>
          </div>
        </div>
        <div class="faq-card">
          ...
          <div>
            <h5>Staffing</h5>
            <p class="body--text">
              See how we handle your staffing needs with our comprehensive staffing services, including recruitment,
    ...
    <section class="faq-list mb-5 container">
...
export default {
  components: { newsLetter, FaqHeader },
};
</script>
