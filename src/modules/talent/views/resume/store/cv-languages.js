...
export default {
  ...
  actions: {
    ...
    async list({ commit }) {
      ...
      try {
        let res = await $request.get(`talent/resume/languages`);
    ...
    async view({ commit }, id) {
      ...
      commit("SET_LOADING", true);
      try {
        let res = await $request.get(`talent/resume/languages/${id}`);
        console.log(res.data);
        let responsePayload = res.data.data;
    ...
    async create({ commit, dispatch }, payload) {
      commit("SET_LOADING");
      try {
        let response = await $request.post("talent/resume/languages", payload);
    ...
    // Delete Language
    async deleteLanguage({ commit, dispatch }, id) {
      commit("SET_LOADING");
      try {
        let response = await $request.delete("talent/resume/languages/" + id);
        console.log(response);
        let responsePayload = response.data;
        toastify({
          text: `${responsePayload.message}`,
