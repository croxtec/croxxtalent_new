...
export default {
  ...
  actions: {
    ...
    async list({ commit }) {
      ...
      try {
        let res = await $request.get(`talent/resume/references`);
    ...
    async view({ commit }, id) {
      ...
      commit("SET_LOADING", true);
      try {
        let res = await $request.get(`talent/resume/references/${id}`);
        console.log(res.data);
        let responsePayload = res.data.data;
    ...
    async create({ commit, dispatch }, payload) {
      commit("SET_LOADING");
      try {
        let response = await $request.post("talent/resume/references", payload);
    ...
    // Delete Record
    async deleteReferences({ commit, dispatch }, id) {
      commit("SET_LOADING");
      try {
        let response = await $request.delete(`talent/resume/references/${id}`);
        let responsePayload = response.data;
