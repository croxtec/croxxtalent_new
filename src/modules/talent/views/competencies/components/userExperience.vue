    ...
    <div class="accordion" id="accordionExample">
      <div class="card cardless">
        <div class="card-header" id="headingOne">
          <h2 class="mb-0 d-flex">
            <button
              class="btn btn-block text-left font-weight-bold"
              type="button"
            ...
            <div class="row my-3">
              <div class="card col-sm m-3 rounded" style="width: 18rem">
                <div class="card-body">
                  ...
                  <div class="d-flex">
                    <span class="btn btn-primary rounded-pill mr-2"
                      >Complete task</span
                    >
                  </div>
                </div>
      ...
      <div class="card cardless">
        <div class="card-header" id="headingTwo">
          <h2 class="mb-0 d-flex">
            <button
              class="btn btn-block text-left collapsed font-weight-bold"
              type="button"
              data-toggle="collapse"
