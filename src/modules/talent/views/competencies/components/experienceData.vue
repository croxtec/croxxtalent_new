        ...
        <el-collapse v-model="activeNames" @change="handleChange">
          <el-collapse-item  v-for="(employee, key) in experience" :key="employee.id"
            ...
            <div class="skills-content mt-3">
              <div class="d-flex">
                <CompetenciesCard class="col-4"  v-for="skill in employee.competence" :key="skill.id" :cxCompetence="skill"/>
              </div>
              <!-- <div class="skills-data col-4" v-for="skill in employee.competence" :key="skill.id">
                <div>
                  <h5>{{ skill.name }}</h5>
                </div>
                <div class="assesement-completed level-poor mt-2" v-if="skill.is_published && skill.score_average <= 2">
                  <div class="assesement-grade" >
                    ...
                    <div class="w-25"> 
                      <div class="assement-score score-poor">
                        ...
                        <span class="h3"> {{skill.score_average}} </span> 
                      </div>
                    </div>
                  </div>
                </div>
                <div class="assesement-completed level-average mt-2" v-else-if="skill.is_published && (skill.score_average > 2 && skill.score_average <= 4 )">
                  <div class="assesement-grade">
                    <div class="w-75 d-flex"> 
                      <span class="info">Completed</span>  
                ...
                <div class="assesement-completed level-excellent mt-2" v-else-if="skill.is_published && skill.score_average > 4">
                  <div class="assesement-grade">
                    <div class="w-75 d-flex"> 
                      <span class="info">Completed</span>  
                ...
                <div class="mt-3 d-flex align-items-center" style="gap: 20px">
                  <router-link v-if="!skill.is_published" :to="{ name: 'assessment', params: { id: skill.code }}"
                      class="primary--button text-white" style="color: inherit;"
                      >Take Test</router-link
                    >
                  <button  v-if="skill.is_published" class="primary--button_border">Preview</button>
                </div>
              </div> -->
            </div>
          </el-collapse-item>
