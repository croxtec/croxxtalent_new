<template>
  <div class="list-job d-flex justify-content-between">
    ...
    <div class="d-flex" style="gap: 10px">
      <img
        :src="job.photo_url ? job.photo_url : require('@/assets/img/box.png')"
        alt="company logo"
        class="img-fluid m-0"
...
export default {
  ...
  props: {
    ...
    showViewButton: Boolean, // Initialize the optionModal prop
    showProgressButton: Boolean, // Initialize the optionModal prop
  },
  methods: {
