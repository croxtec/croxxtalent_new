<template><div>               <header class="d-flex sorting_section justify-content-between">
    ...
    <div class="job-grid">
        <div class="job-list">
            <div class="list">
                <RowJobCard v-for="job in jobs" :key="job.id" :job="job.campaign" :showButton="true" :optionModal="optionModal"
